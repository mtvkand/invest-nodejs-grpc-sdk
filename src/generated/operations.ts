...
export const PortfolioResponse = {
  ...
  toJSON(message: PortfolioResponse): unknown {
    ...
    message.totalAmountShares !== undefined &&
      (obj.totalAmountShares = message.totalAmountShares ? MoneyValue.toJSON(message.totalAmountShares) : undefined);
...
export const PositionsResponse = {
  ...
  fromJSON(object: any): PositionsResponse {
    return {
      money: Array.isArray(object?.money) ? object.money.map((e: any) => MoneyValue.fromJSON(e)) : [],
      blocked: Array.isArray(object?.blocked) ? object.blocked.map((e: any) => MoneyValue.fromJSON(e)) : [],
...
export const BrokerReport = {
  ...
  toJSON(message: BrokerReport): unknown {
    ...
    message.orderAmount !== undefined &&
      (obj.orderAmount = message.orderAmount ? MoneyValue.toJSON(message.orderAmount) : undefined);
    message.aciValue !== undefined &&
      (obj.aciValue = message.aciValue ? Quotation.toJSON(message.aciValue) : undefined);
    ...
    message.brokerCommission !== undefined &&
      (obj.brokerCommission = message.brokerCommission ? MoneyValue.toJSON(message.brokerCommission) : undefined);
    message.exchangeCommission !== undefined &&
      (obj.exchangeCommission = message.exchangeCommission ? MoneyValue.toJSON(message.exchangeCommission) : undefined);
    ...
    message.repoRate !== undefined &&
      (obj.repoRate = message.repoRate ? Quotation.toJSON(message.repoRate) : undefined);
...
export const DividendsForeignIssuerReport = {
  ...
  toJSON(message: DividendsForeignIssuerReport): unknown {
    ...
    message.dividend !== undefined &&
      (obj.dividend = message.dividend ? Quotation.toJSON(message.dividend) : undefined);
    message.externalCommission !== undefined &&
      (obj.externalCommission = message.externalCommission ? Quotation.toJSON(message.externalCommission) : undefined);
    message.dividendGross !== undefined &&
      (obj.dividendGross = message.dividendGross ? Quotation.toJSON(message.dividendGross) : undefined);
    message.tax !== undefined && (obj.tax = message.tax ? Quotation.toJSON(message.tax) : undefined);
    message.dividendAmount !== undefined &&
      (obj.dividendAmount = message.dividendAmount ? Quotation.toJSON(message.dividendAmount) : undefined);
    message.currency !== undefined && (obj.currency = message.currency);
    return obj;
  },
