...
export const TradingSchedulesResponse = {
  ...
  fromJSON(object: any): TradingSchedulesResponse {
    return {
      exchanges: Array.isArray(object?.exchanges) ? object.exchanges.map((e: any) => TradingSchedule.fromJSON(e)) : [],
    };
  },
...
export const BondsResponse = {
  ...
  fromJSON(object: any): BondsResponse {
    return {
      instruments: Array.isArray(object?.instruments) ? object.instruments.map((e: any) => Bond.fromJSON(e)) : [],
    };
  },
...
export const Coupon = {
  ...
  toJSON(message: Coupon): unknown {
    ...
    message.payOneBond !== undefined &&
      (obj.payOneBond = message.payOneBond ? MoneyValue.toJSON(message.payOneBond) : undefined);
...
export const CurrencyResponse = {
  ...
  toJSON(message: CurrencyResponse): unknown {
    const obj: any = {};
    message.instrument !== undefined &&
      (obj.instrument = message.instrument ? Currency.toJSON(message.instrument) : undefined);
    return obj;
  },
...
export const CurrenciesResponse = {
  ...
  fromJSON(object: any): CurrenciesResponse {
    return {
      instruments: Array.isArray(object?.instruments) ? object.instruments.map((e: any) => Currency.fromJSON(e)) : [],
    };
  },
...
export const EtfsResponse = {
  ...
  fromJSON(object: any): EtfsResponse {
    return {
      instruments: Array.isArray(object?.instruments) ? object.instruments.map((e: any) => Etf.fromJSON(e)) : [],
    };
  },
...
export const FuturesResponse = {
  ...
  fromJSON(object: any): FuturesResponse {
    return {
      instruments: Array.isArray(object?.instruments) ? object.instruments.map((e: any) => Future.fromJSON(e)) : [],
    };
  },
...
export const ShareResponse = {
  ...
  toJSON(message: ShareResponse): unknown {
    const obj: any = {};
    message.instrument !== undefined &&
      (obj.instrument = message.instrument ? Share.toJSON(message.instrument) : undefined);
    return obj;
  },
...
export const SharesResponse = {
  ...
  fromJSON(object: any): SharesResponse {
    return {
      instruments: Array.isArray(object?.instruments) ? object.instruments.map((e: any) => Share.fromJSON(e)) : [],
    };
  },
...
export const Bond = {
  ...
  toJSON(message: Bond): unknown {
    ...
    message.placementPrice !== undefined &&
      (obj.placementPrice = message.placementPrice ? MoneyValue.toJSON(message.placementPrice) : undefined);
...
export const Etf = {
  ...
  toJSON(message: Etf): unknown {
    ...
    message.fixedCommission !== undefined &&
      (obj.fixedCommission = message.fixedCommission ? Quotation.toJSON(message.fixedCommission) : undefined);
    ...
    message.numShares !== undefined &&
      (obj.numShares = message.numShares ? Quotation.toJSON(message.numShares) : undefined);
    message.countryOfRisk !== undefined && (obj.countryOfRisk = message.countryOfRisk);
    message.countryOfRiskName !== undefined && (obj.countryOfRiskName = message.countryOfRiskName);
    message.sector !== undefined && (obj.sector = message.sector);
...
export const AccruedInterest = {
  ...
  toJSON(message: AccruedInterest): unknown {
    const obj: any = {};
    message.date !== undefined && (obj.date = message.date.toISOString());
    message.value !== undefined && (obj.value = message.value ? Quotation.toJSON(message.value) : undefined);
    message.valuePercent !== undefined &&
      (obj.valuePercent = message.valuePercent ? Quotation.toJSON(message.valuePercent) : undefined);
...
export const InstrumentResponse = {
  ...
  toJSON(message: InstrumentResponse): unknown {
    const obj: any = {};
    message.instrument !== undefined &&
      (obj.instrument = message.instrument ? Instrument.toJSON(message.instrument) : undefined);
    return obj;
  },
...
export const GetDividendsResponse = {
  ...
  fromJSON(object: any): GetDividendsResponse {
    return {
      dividends: Array.isArray(object?.dividends) ? object.dividends.map((e: any) => Dividend.fromJSON(e)) : [],
    };
  },
...
export const Dividend = {
  ...
  toJSON(message: Dividend): unknown {
    ...
    message.dividendNet !== undefined &&
      (obj.dividendNet = message.dividendNet ? MoneyValue.toJSON(message.dividendNet) : undefined);
    ...
    message.closePrice !== undefined &&
      (obj.closePrice = message.closePrice ? MoneyValue.toJSON(message.closePrice) : undefined);
    message.yieldValue !== undefined &&
      (obj.yieldValue = message.yieldValue ? Quotation.toJSON(message.yieldValue) : undefined);
...
export const AssetResponse = {
  ...
  toJSON(message: AssetResponse): unknown {
    const obj: any = {};
    message.asset !== undefined && (obj.asset = message.asset ? AssetFull.toJSON(message.asset) : undefined);
    return obj;
  },
...
export const AssetFull = {
  ...
  toJSON(message: AssetFull): unknown {
    ...
    message.currency !== undefined &&
      (obj.currency = message.currency ? AssetCurrency.toJSON(message.currency) : undefined);
    message.security !== undefined &&
      (obj.security = message.security ? AssetSecurity.toJSON(message.security) : undefined);
    ...
    message.brand !== undefined && (obj.brand = message.brand ? Brand.toJSON(message.brand) : undefined);
...
export const AssetShare = {
  ...
  toJSON(message: AssetShare): unknown {
    ...
    message.issueSize !== undefined &&
      (obj.issueSize = message.issueSize ? Quotation.toJSON(message.issueSize) : undefined);
    message.nominal !== undefined && (obj.nominal = message.nominal ? Quotation.toJSON(message.nominal) : undefined);
    ...
    message.dividendRate !== undefined &&
      (obj.dividendRate = message.dividendRate ? Quotation.toJSON(message.dividendRate) : undefined);
    ...
    message.issueSizePlan !== undefined &&
      (obj.issueSizePlan = message.issueSizePlan ? Quotation.toJSON(message.issueSizePlan) : undefined);
...
export const AssetBond = {
  ...
  toJSON(message: AssetBond): unknown {
    ...
    message.currentNominal !== undefined &&
      (obj.currentNominal = message.currentNominal ? Quotation.toJSON(message.currentNominal) : undefined);
    ...
    message.placementDate !== undefined && (obj.placementDate = message.placementDate.toISOString());
    message.placementPrice !== undefined &&
      (obj.placementPrice = message.placementPrice ? Quotation.toJSON(message.placementPrice) : undefined);
    message.issueSizePlan !== undefined &&
      (obj.issueSizePlan = message.issueSizePlan ? Quotation.toJSON(message.issueSizePlan) : undefined);
    return obj;
  },
...
export const AssetStructuredProduct = {
  ...
  toJSON(message: AssetStructuredProduct): unknown {
    ...
    message.safetyBarrier !== undefined &&
      (obj.safetyBarrier = message.safetyBarrier ? Quotation.toJSON(message.safetyBarrier) : undefined);
    message.maturityDate !== undefined && (obj.maturityDate = message.maturityDate.toISOString());
    message.issueSizePlan !== undefined &&
      (obj.issueSizePlan = message.issueSizePlan ? Quotation.toJSON(message.issueSizePlan) : undefined);
    message.issueSize !== undefined &&
...
export const AssetEtf = {
  ...
  toJSON(message: AssetEtf): unknown {
    ...
    message.totalExpense !== undefined &&
      (obj.totalExpense = message.totalExpense ? Quotation.toJSON(message.totalExpense) : undefined);
    message.hurdleRate !== undefined &&
      (obj.hurdleRate = message.hurdleRate ? Quotation.toJSON(message.hurdleRate) : undefined);
    message.performanceFee !== undefined &&
      (obj.performanceFee = message.performanceFee ? Quotation.toJSON(message.performanceFee) : undefined);
    message.fixedCommission !== undefined &&
      (obj.fixedCommission = message.fixedCommission ? Quotation.toJSON(message.fixedCommission) : undefined);
    ...
    message.buyPremium !== undefined &&
      (obj.buyPremium = message.buyPremium ? Quotation.toJSON(message.buyPremium) : undefined);
    message.sellDiscount !== undefined &&
      (obj.sellDiscount = message.sellDiscount ? Quotation.toJSON(message.sellDiscount) : undefined);
    ...
    message.numShare !== undefined &&
      (obj.numShare = message.numShare ? Quotation.toJSON(message.numShare) : undefined);
    ...
    message.expenseCommission !== undefined &&
      (obj.expenseCommission = message.expenseCommission ? Quotation.toJSON(message.expenseCommission) : undefined);
