// @copypaste https://github.com/Tinkoff/investAPI/blob/861941e4c404b14b8dbfc376bc56fe03d959d7fb/src/docs/errors/api_errors.json
type Errors = {
...
export const errorStatus: Errors = {
  ...
  "30005": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *id_type* имеет некорректное значение.</br>Список доступных значений: [*id_type*](https://tinkoff.github.io/investAPI/instruments#instrumentidtype)."
  },
  "30006": {
  ...
  "30011": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *interval* имеет некорректное значение.</br>Список доступных значений: [*interval*](https://tinkoff.github.io/investAPI/marketdata#subscriptioninterval)."
  },
  "30012": {
  ...
  "30013": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *class_code* не может быть пустым при поиске по тикеру. </br>Укажите корректный параметр *class_code*. </br>Подробнее: [Идентификация инструментов](https://tinkoff.github.io/investAPI/faq_identification/)."
  },
  "30014": {
    "message": "the maximum request period for the given candle interval has been exceeded",
    "type": "INVALID_ARGUMENT",
    "description": "Превышен максимальный период запроса для данного интервала свечи. </br>Укажите корректный интервал."
  },
  "30015": {
  ...
  "30017": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *price* является обязательным. </br> Укажите корректный параметр *price*."
  },
  "30018": {
  ...
  "30020": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *direction* имеет некорректное значение.</br>Список доступных значений: [*direction*](https://tinkoff.github.io/investAPI/stoporders/#stoporderdirection)."
  },
  "30021": {
  ...
  "30025": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *order_type* является обязательным. </br> Укажите корректный параметр *order_type*."
  },
  "30027": {
  ...
  "30034": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Недостаточно средств для совершения сделки (ошибка песочницы). </br>Пополните баланс нужной валюты."
  },
  "30036": {
  ...
  "30037": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *stop_order_type* является обязательным. </br>Укажите корректный параметр *stop_order_type*."
  },
  "30038": {
    "message": "'stop_order_type' is invalid",
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *stop_order_type* имеет некорректное значение.</br>Список доступных значений: [*stop_order_type*](https://tinkoff.github.io/investAPI/stoporders/#stopordertype)."
  },
  "30040": {
  ...
  "30042": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Недостаточно активов для маржинальной сделки. </br>Проверьте маржинальные показатели счёта."
  },
  "30043": {
  ...
  "30044": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *expiration_type* имеет некорректное значение.</br>Список доступных значений: [*expiration_type*](https://tinkoff.github.io/investAPI/stoporders/#stoporderexpirationtype)."
  },
  "30045": {
  ...
  "30047": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Валюта цены не совпадает с валютой расчётов по инструменту. </br>Укажите корректную валюту цены."
  },
  "30048": {
  ...
  "30050": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *instrument_status* имеет некорректное значение.</br>Список доступных значений: [*instrument_status*](https://tinkoff.github.io/investAPI/instruments#instrumentstatus)."
  },
  "30051": {
  ...
  "40002": {
    ...
    "description": "Недостаточно прав для совершения операции. </br>Токен доступа имеет уровень прав read-only.</br>Подробнее: [Виды токенов](https://tinkoff.github.io/investAPI/index#_2)"
  },
  ...
  "70002": {
    ...
    "type": "INTERNAL",
    "description": "Неизвестная сетевая ошибка, попробуйте выполнить запрос позднее.</br>Если ошибка повторяется, обратитесь в службу технической поддержки."
  },
  "70003": {
    "message": "internal error, please try again later",
    "type": "INTERNAL",
    "description": "Внутренняя ошибка сервиса, попробуйте выполнить запрос позднее.</br>Если ошибка повторяется, обратитесь в службу технической поддержки."
  },
  "80001": {
